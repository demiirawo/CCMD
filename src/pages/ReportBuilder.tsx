      ...
      <div className="container mx-auto p-6 max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            {quarter} {year} - Add context and attachments to enhance your AI-generated report
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <Textarea
                  id="context"
                  placeholder="Enter any additional context, specific areas to focus on, recent developments, or special considerations that should be included in the quarterly report..."
