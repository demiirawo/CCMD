...
export const StaffTrainingAnalytics = ({
  ...
  const handleTableCellEdit = (rowIndex: number, field: string, value: string) => {
    ...
    setMonthlyData(prev => prev.map((row, index) => index === rowIndex ? {
      ...row,
      [field]: numValue
    } : row));
  };
  ...
  const EditableCell = ({
    ...
    className?: string;
  }) => <Input value={value} onChange={e => onEdit(e.target.value)} className={`${className} [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`} style={{
  ...
  return <div className="bg-white rounded-lg border border-border/30 overflow-hidden">
      <div className="p-6">
                    ...
                    <ChartContainer config={chartConfig} className="w-full h-full">
                      ...
                      bottom: 5
                        ...
                        fontSize: 12
                          ...
                          <Line type="monotone" dataKey="mandatoryPercentage" stroke="#3b82f6" strokeWidth={2} dot={{
                        fill: "#3b82f6",
                        strokeWidth: 2,
                        r: 4
                      }} />
                          <Line type="monotone" dataKey="specialistPercentage" stroke="#22c55e" strokeWidth={2} dot={{
                        fill: "#22c55e",
                        strokeWidth: 2,
                        r: 4
                      }} />
                  ...
                  <CardContent className="p-6">
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        ...
                        <tbody>
                          {monthlyData.map((data, index) => <tr key={data.month} className="border-b">
                              <td className="py-3 px-4">{data.month}</td>
                              <td className="py-3 px-4">
                                <EditableCell value={data.mandatoryComplete} onEdit={val => handleTableCellEdit(index, 'mandatoryComplete', val)} />
                              </td>
                              <td className="py-3 px-4">
                                <EditableCell value={data.mandatoryTotal} onEdit={val => handleTableCellEdit(index, 'mandatoryTotal', val)} />
                              </td>
                            </tr>)}
                        </tbody>
                      </table>
                    ...
                    <Card>
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <EditableCell value={currentMetrics.mandatoryComplete} onEdit={val => handleCurrentMetricEdit('mandatoryComplete', val)} className="w-20 h-10 text-center" />
                        </div>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <EditableCell value={currentMetrics.mandatoryIncomplete} onEdit={val => handleCurrentMetricEdit('mandatoryIncomplete', val)} className="w-20 h-10 text-center" />
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                      ...
                      <table className="w-full">
                        ...
                        <tbody>
                          {monthlyData.map((data, index) => <tr key={data.month} className="border-b">
                              <td className="py-3 px-4">{data.month}</td>
                              <td className="py-3 px-4">
                                <EditableCell value={data.specialistComplete} onEdit={val => handleTableCellEdit(index, 'specialistComplete', val)} />
                              </td>
                              <td className="py-3 px-4">
                                <EditableCell value={data.specialistTotal} onEdit={val => handleTableCellEdit(index, 'specialistTotal', val)} />
                              </td>
                            </tr>)}
                        </tbody>
                      </table>
                    ...
                    <Card>
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <EditableCell value={currentMetrics.specialistComplete} onEdit={val => handleCurrentMetricEdit('specialistComplete', val)} className="w-20 h-10 text-center" />
                        </div>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <EditableCell value={currentMetrics.specialistIncomplete} onEdit={val => handleCurrentMetricEdit('specialistIncomplete', val)} className="w-20 h-10 text-center" />
                        </div>
                      </CardContent>
                    </Card>
                  </div>
