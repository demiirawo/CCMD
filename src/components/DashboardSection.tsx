...
export const DashboardSection = ({
  ...
  const getSectionBackgroundClass = (status: string) => {
    const isHighLevelPanel = ["Staffing", "Care & Support", "Support Planning & Delivery", "Safety", "Continuous Improvement", "Compliance Documents", "Actions", "Supported Housing"].includes(title);
