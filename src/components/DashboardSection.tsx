            ...
            {(() => {
              ...
              return (
                <>
                  <h3 className={cn(
                    "text-xl font-bold",
                    isHighLevelPanel && isDynamicPanelColourEnabled ? "text-black" : "text-foreground"
                  )}>{title}</h3>
                  {getLastUpdated() && (
                    <p className={cn(
                      "text-sm mt-1",
                      isHighLevelPanel && isDynamicPanelColourEnabled ? "text-black/80" : "text-muted-foreground"
                    )}>
