...
export const DashboardSection = ({
  ...
  const getSectionBackgroundClass = (status: string) => {
    const isHighLevelPanel = ["Staffing", "Care & Support", "Support Planning & Delivery", "Safety", "Continuous Improvement", "Key Review Dates", "Actions", "Supported Housing"].includes(title);
