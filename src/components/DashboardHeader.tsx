      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        ...
        <div className="space-y-4">
          <div className="p-4 rounded-lg border border-gray-100 text-center bg-white">
            ...
            {currentCompany?.logo_url && <div className="flex justify-center">
                <img src={currentCompany.logo_url} alt={`${currentCompany.name} logo`} className="w-20 h-20 rounded-lg object-cover border border-gray-200" />
              </div>}
          </div>
        </div>
