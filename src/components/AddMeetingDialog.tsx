...
export const AddMeetingDialog = ({ onMeetingAdded }: AddMeetingDialogProps) => {
    ...
    try {
      ...
      toast({
        ...
        description: selectedFile 
          ? "Meeting created with document attached" 
          : "Meeting created",
      });

      setFormData({ title: "", purpose: "", date: undefined });
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Enter meeting purpose (optional)"
              rows={3}
            />
          </div>
