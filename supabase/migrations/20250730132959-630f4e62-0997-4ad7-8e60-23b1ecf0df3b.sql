-- Create Demo Client company with proper UUID
DO $$
DECLARE 
    demo_company_id uuid := gen_random_uuid();
    demo_user_id uuid := gen_random_uuid();
    demo_profile_id uuid := gen_random_uuid();
BEGIN
    ...
    -- Create a demo profile for the company
    ...
    INSERT INTO public.care_plan_analytics (company_id, monthly_data, frequencies, created_at, updated_at) 
    VALUES (
      demo_company_id,
      '[
    ...
    INSERT INTO public.incidents_analytics (company_id, monthly_data, created_at, updated_at) 
    VALUES (
      demo_company_id,
      '[
    ...
    -- Continue with other analytics tables...
    -- Staff Training Analytics
    INSERT INTO public.staff_training_analytics (company_id, training_data, created_at, updated_at) 
    VALUES (
      demo_company_id,
      '{
    ...
    INSERT INTO public.staff_documents_analytics (company_id, documents_data, created_at, updated_at) 
    VALUES (
      demo_company_id,
      '{
        "total_staff": 50,
    ...
    -- Raise a notice with the company ID for reference
    RAISE NOTICE 'Demo Client created with ID: %', demo_company_id;
END $$;